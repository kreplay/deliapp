            ...
            if($typ){
                switch($typ) {
                    case 'iframe':
                        ...
                        $code = "<if"."rame class='metaframe rptss' src='https://pandrama.net/p/gf/index.php?url={$url}' frameborder='0' scrolling='no' allow='autoplay; encrypted-media' allowfullscreen></ifr"."ame>";
                        
                        break;

                        case 'Solidfiles':
                        
                        $code = "<if"."rame class='metaframe rptss' src='https://pandrama.net/p/sd/embed.php?url={$url}' frameborder='0' scrolling='no' allow='autoplay; encrypted-media' allowfullscreen></ifr"."ame>";
