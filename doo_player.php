            ...
            if($typ){
                switch($typ) {
                    case 'iframe':
                        ...
                        $code = "<if"."rame class='metaframe rptss' src='https://pandrama.com/p/gf/index.php?url=https://photos.google.com/share/{$url}' frameborder='0' scrolling='no' allow='autoplay; encrypted-media' allowfullscreen></ifr"."ame>";
                        
                        break;
                        
                        case 'AMAZON':
                        
                        $code = "<if"."rame class='metaframe rptss' src='https://pandrama.com/p/amc/playeramc.php?key={$url}' frameborder='0' scrolling='no' allow='autoplay; encrypted-media' allowfullscreen></ifr"."ame>";
                        
                        break;
                        
                        case 'Solidfiles':
                        
                        $code = "<if"."rame class='metaframe rptss' src='https://pandrama.com/p/sd/embed.php?url={$url}' frameborder='0' scrolling='no' allow='autoplay; encrypted-media' allowfullscreen></ifr"."ame>";
                       
                        break;
                         case 'Yandex':
                        
                        $code = "<if"."rame class='metaframe rptss' src='https://pandrama.com/p/yd/index.php/?id={$url}' frameborder='0' scrolling='no' allow='autoplay; encrypted-media' allowfullscreen></ifr"."ame>";
